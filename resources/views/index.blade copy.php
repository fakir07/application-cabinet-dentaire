		...
		<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
			...
			<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
				...
				<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">
					...
					<!--end::Separator-->
					<!--begin::Description-->
					<small class="text-muted fs-7 fw-bold my-1 ms-1">Rendez-vous</small>
					<!--end::Description-->
				</h1>
				<!--end::Title-->
			</div>
						...
						<table id="kt_datatable_example_5"
							...
							<tbody class="text-gray-600 fw-bold">
								...
								<tr class="">
									...
									<td>{{
										 date('m/d/Y, g:i', strtotime($rdv->start_date))
									}}</td>
									<td>{{ $rdv->user->name }}</td>
									<!--begin::Joined-->
									<!--begin::Action=-->
																		...
																		<div class="row  mx-6 my-6">
																				...
																				<div class="col fv-row fv-plugins-icon-container">
																					...
																					<select class="form-select border" name="type_rend" aria-label="Default select example">
																						...
																						<option value="Masculine" {{  $rdv->type_rend ==  "Masculine" ? "selected" : ""}}>Masculine  </option>
																						<option value="Féminine" {{  $rdv->type_rend ==  "Féminine" ? "selected" : ""}}>Féminine</option>
																					</select>
																					<!--end::Input-->
																					<div
																						class="fv-plugins-message-container invalid-feedback">
																				...
																				<div class="col fv-row fv-plugins-icon-container">
																					...
																					<select class="form-select border" name="statu_rend" aria-label="Default select example">
																						<option selected disabled>Open this select </option>
																						<option value="Masculine" {{  $rdv->statu_rend ==  "Masculine" ? "selected" : ""}}>Masculine  </option>
																						<option value="Féminine" {{  $rdv->statu_rend ==  "Féminine" ? "selected" : ""}}>Féminine</option>
																					</select>
																					<!--end::Input-->
																					<div
																						class="fv-plugins-message-container invalid-feedback">
